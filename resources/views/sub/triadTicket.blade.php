...
<div class="card">
    <div class="card-header">
        <h4 class="card-title text-black">Triad Coaching Plan</h4>		
    </div>
    <div class="card-body">
        <div class="row">
            <div class="col-lg-6 mb-2">
                <div class="card">
                    <div class="card-body">
                        ...
                        <select class="form-control append-ticket" id="body-language-score"  placeholder="This is a search placeholder">
            ...
            <div class="col-lg-4">
                <button class="btn btn-primary w-50" id="submit-triad">Submit</button>
            </div>
