...
<div class="card">
    <div class="card-body">
        <div class="row g-2 align-items-end">
            <div class="col-md-3">
                <label class="form-label font-size-13 mb-1">Recon Date Range</label>
                <input type="text" id="recon-date-range" class="form-control form-control-sm" placeholder="All dates" readonly>
                <input type="hidden" id="recon-date-from">
                <input type="hidden" id="recon-date-to">
            </div>
            <div class="col-md-2">
                <label class="form-label font-size-13 mb-1">Carrier Code</label>
                <select id="recon-carrier-code" class="form-select form-select-sm">
                    <option value="">All Carriers</option>
                </select>
            </div>
            <div class="col-md-2">
                <label class="form-label font-size-13 mb-1">Client Code</label>
                <select id="recon-client-code" class="form-select form-select-sm">
