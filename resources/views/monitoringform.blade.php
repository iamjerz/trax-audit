...
<body>
        ...
        <div class="page-content">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <h5 class="card-title">QA Monitoring Form</h5>
                        </div>
                    </div>
                </div>
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" data-trigger name="audit-sup-name" id="choices-single-default" placeholder="This is a search placeholder">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" data-trigger name="auditors-name" id="choices-single-default" placeholder="This is a search placeholder">
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control flatpickr-input datepicker-humanfd" name="audit-date2" id="audit-date2" placeholder="Select Audit Date">
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="ver-iden-1-outcome" id="ver-iden-1-outcome">
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <h5 class="font-size-14">R&C Outcome</h5>
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="ver-iden-2-outcome" id="ver-iden-2-outcome">
                                                                <option value="">Select Rating</option>
                                                                <option value="100">Pass</option>
                                                                <option value="0">Fail</option>
                                                            </select>
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="pro-com-1-outcome" id="pro-com-1-outcome">
                                                                <option value="">Select Rating</option>
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <h5 class="font-size-14">PC Outcome</h5>
                                                        <div class="mb-3">
                                                            <select class="form-control"  data-trigger name="pro-com-2-outcome" id="pro-com-2-outcome">
                                                                <option value="">Select Rating</option>
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <h5 class="font-size-14">PC Outcome</h5>
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="pro-com-3-outcome" id="pro-com-3-outcome">
                                                                <option value="">Select Rating</option>
                                                                <option value="15">Met</option>
                                                                <option value="8">Coached</option>
                                                                <option value="0">Not Met</option>
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <h5 class="font-size-14">PC Outcome</h5>
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="pro-com-4-outcome" id="pro-com-4-outcome">
                                                                <option value="">Select Rating</option>
                                                                <option value="10">Met</option>
                                                                <option value="5">Coached</option>
                                                                <option value="0">Not Met</option>
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="engagement-1-outcome" id="engagement-1-outcome">
                                                                <option value="">Select Rating</option>
                                                                <option value="10">Met</option>
                                                                <option value="5">Coached</option>
                                                                <option value="0">Not Met</option>
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <h5 class="font-size-14">CE Outcome</h5>
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="engagement-2-outcome" id="engagement-2-outcome">
                                                                <option value="">Select Rating</option>
                                                                <option value="10">Met</option>
                                                                <option value="5">Coached</option>
                                                                <option value="0">Not Met</option>
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <h5 class="font-size-14">CE Outcome</h5>
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="engagement-3-outcome" id="engagement-3-outcome">
                                                                <option value="">Select Rating</option>
                                                                <option value="15">Met</option>
                                                                <option value="8">Coached</option>
                                                                <option value="0">Not Met</option>
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <h5 class="font-size-14">CE Outcome</h5>
                                                        <div class="mb-3">
                                                            <select class="form-control" data-trigger name="engagement-4-outcome" id="engagement-4-outcome">
                                                                <option value="">Select Rating</option>
                                                                <option value="15">Met</option>
                                                                <option value="8">Coached</option>
                                                                <option value="0">Not Met</option>
                                ...
                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-control" data-trigger name="sign-carrier" id="sign-carrier" placeholder="This is a search placeholder">
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-control" data-trigger name="follow-up" id="follow-up" placeholder="This is a search placeholder">
                                                                    <option value="">Select Option</option>
                                                                    <option value="Yes">Yes</option>
                                                                    <option value="No">No</option>
                                                                </select>
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-control" data-trigger name="cause-issue" id="cause-issue" placeholder="This is a search placeholder">
                                                                    <option value="">Select Option</option>
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-control" data-trigger name="impact-area" id="impact-area" placeholder="This is a search placeholder">
                                                                    <option value="">Select Option</option>
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-control" data-trigger name="impact-factor" id="impact-factor" placeholder="This is a search placeholder">
                                                                    <option value="">Select Option</option>
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-control" data-trigger name="accountable-factors" id="accountable-factors" placeholder="This is a search placeholder">
                                                                    <option value="">Select Option</option>
                                                        ...
                                                        <div class="mb-3 row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select class="form-control" data-trigger name="root-cause" id="root-cause" placeholder="This is a search placeholder">
                                                                    <option value="">Select Option</option>
                                    ...
                                    <div class="col-lg-4 d-flex"><!-- ✅ added d-flex -->
                                        <div class="card h-100 w-100 d-flex flex-column"><!-- ✅ added h-100 + flex -->
                                            ...
                                            <div class="card-footer bg-transparent border-top">
                                                <div class="row">
                                                    <button type="submit" id="submitBtn" class="btn btn-primary w-100">Submit Audit</button>
                                                </div>
                                            </div>
    ...
    <script src="{{ asset('assets/js/monitoringform.js') }}"></script>
