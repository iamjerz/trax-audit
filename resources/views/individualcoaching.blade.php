...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3 text-end">
                            <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#change-coached-employee">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <small class="text-muted">Coached Employee</small>
                                        <div class="fw-semibold">
                                            {{ trim(($coachedEmployee->FirstName ?? '') . ' ' . ($coachedEmployee->LastName ?? '')) ?: 'N/A' }}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    <div class="modal fade" id="change-coached-employee" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <label for="coached-employee" class="form-label">Coached Employee <span class="text-danger">*</span></label>
                    <select class="form-control" data-choice name="coached-employee" id="coached-employee" placeholder="This is a search placeholder">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="update-coached-employee">Update</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on('click', '#update-coached-employee', async function() {
                try {
                    const pathParts = window.location.pathname.split('/');
                    const id = pathParts[pathParts.length - 1];

                    const employeeId = document.getElementById('coached-employee').value;

                    const res = await fetch(`/coaching/assign-employee/${id}`, {
                        method: 'POST',
                        headers: {
