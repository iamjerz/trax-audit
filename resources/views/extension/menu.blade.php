            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        @if($pageAccess->contains('extension_action_register'))
                        ...
                        @if($pageAccess->contains('extension_monitoring'))
                        ...
                        @if($pageAccess->contains('extension_coaching'))
                        ...
                        @if($pageAccess->contains('extension_triad'))
